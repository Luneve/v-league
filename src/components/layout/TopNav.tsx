...
function TopNav({
  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-border bg-surface px-4 lg:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Avatar */}
        <div className="flex h-9 w-9 items-center justify-center rounded-full bg-accent text-white text-sm font-medium cursor-pointer" title={userName}>
          {userInitials}
        </div>
      </div>
    </header>
