...
export type Database = {
  ...
  public: {
    ...
    Views: {
      opportunities_with_counts: {
        Row: {
          ...
          description: string | null
          effective_status: Database["public"]["Enums"]["opp_status"] | null
          end_at: string | null
    ...
    Functions: {
      ...
      fn_can_apply: { Args: { p_opportunity_id: string }; Returns: Json }
      fn_close_expired_opportunities: { Args: never; Returns: number }
      ...
      fn_start_season: { Args: { p_duration_days?: number }; Returns: string }
